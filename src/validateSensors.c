...
void set_analog_value(double analogVal, analogSensorInput *analogInput)
{
	analogInput->sensorValue = analogVal;
	return;
}
...
int get_analog_value(analogSensorInput *analogIn)
{
	if (analogIn->sensorValue < -900)
	{
		return 0;
	}
	else
